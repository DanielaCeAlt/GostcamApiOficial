...
"[project]/src/hooks/useSwipeGestures.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function useSwipeGestures() {
    ...
    const [isSwipeDetected, setIsSwipeDetected] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
...
_s(useSwipeGestures, "VZVvQAFBvjmU4RSgNhBemLHHUrg=");
function useTabSwipeNavigation(tabs, currentTab, onTabChange) {
    _s1();
    const currentIndex = tabs.indexOf(currentTab);
    const swipeGestures = useSwipeGestures({
        onSwipeLeft: {
            "useTabSwipeNavigation.useSwipeGestures[swipeGestures]": ()=>{
                // Ir al siguiente tab
...
_s1(useTabSwipeNavigation, "eX+x1DRD4o8clojqWUmyd/65Wgg=", false, function() {
    return [
        useSwipeGestures
    ];
});
function usePaginationSwipe(currentPage, totalPages, onPageChange) {
    ...
    const swipeGestures = useSwipeGestures({
        onSwipeLeft: {
            "usePaginationSwipe.useSwipeGestures[swipeGestures]": ()=>{
                // Página siguiente
...
_s2(usePaginationSwipe, "eX+x1DRD4o8clojqWUmyd/65Wgg=", false, function() {
    return [
        useSwipeGestures
    ];
});
...
//# sourceMappingURL=src_08f92487._.js.map